export default {
  async fetch(request, env) {
    ...
    <head>
        ...
        <style>
            :root { 
                --primary: #FF5722; /* Màu cam đỏ sang trọng hơn */
                --bg: #080808; 
                --card: #121212;
                --text: #ffffff;
            ...
            * { box-sizing: border-box; transition: all 0.25s ease; }
            ...
            .wheel-text { position: absolute; font-size: 0.75rem; font-weight: 800; color: white; text-align: center; width: 100%; height: 100%; top: 0; left: 0; text-shadow: 0 1px 3px rgba(0,0,0,0.5); }
            .t1 { transform: rotate(45deg) translateY(-85px); position: absolute; width: 100%; }
            .t2 { transform: rotate(135deg) translateY(-85px); position: absolute; width: 100%; }
            .t3 { transform: rotate(225deg) translateY(-85px); position: absolute; width: 100%; }
            .t4 { transform: rotate(315deg) translateY(-85px); position: absolute; width: 100%; }

            @keyframes rotateWheel { from { transform: rotate(0deg); } to { transform: rotate(360deg); } }

            /* NÚT NHẬN QUÀ MÀU CAM ĐỎ RỰC RỠ */
            .btn-gift { 
                background: #FF5722; color: white; border: none; padding: 18px; border-radius: 100px; 
                font-weight: 800; width: 100%; cursor: pointer; margin-top: 15px; 
                box-shadow: 0 0 20px rgba(255, 87, 34, 0.5); font-size: 1.05rem;
                text-transform: uppercase; letter-spacing: 1px;
            }
            .btn-gift:hover { transform: scale(1.02); box-shadow: 0 0 30px rgba(255, 87, 34, 0.7); }

            /* BẢNG VÀNG */
            .stat-badge { background: rgba(255,102,0,0.1); color: #FF5722; padding: 6px 15px; border-radius: 100px; font-weight: 700; font-size: 0.8rem; display: inline-block; margin-bottom: 10px; }
    ...
    <header>
        ...
        <div>
            <a href="#" style="color: white; background: #FF5722; padding: 10px 20px; border-radius: 8px; text-decoration: none; font-weight: 700;">Đăng nhập</a>
        </div>
    </header>
    ...
    <div class="funnel-container">
        <div class="funnel-card" style="text-align:center;">
            <h3 style="margin:0; color: #FF5722;">🎡 Vòng Quay May Mắn</h3>
        ...
        <div class="funnel-card">
            ...
            <div style="margin-top: 25px; padding-top: 15px; border-top: 1px solid var(--border);">
                <p style="color: #FF5722; font-weight: 800; margin:0;">🎁 ƯU ĐÃI NHÓM:</p>
    ...
    <div class="container">
        ...
        <div class="card"><h3>Đồng Hành Trọn Đời</h3><p style="color:#888; font-size:0.9rem;">Hỗ trợ định dạng luận văn, đồ án thực tế.</p></div>
    </div>

    <footer>
        <div class="f-grid">
            <div>
                <div style="color: #FF5722; font-size: 1.5rem; font-weight: 800; margin-bottom: 15px;">MOS360.VN</div>
                <p style="color: #777; font-size: 0.9rem;">Hệ thống đào tạo tin học uy tín tại Hải Phòng.</p>
                <p style="color: #FF5722; font-weight: 800;">Hotline: 0912.888.360</p>
            </div>
            <div>
