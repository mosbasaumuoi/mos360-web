    ...
    <head>
        ...
        <style>
            ...
            * { box-sizing: border-box; transition: all 0.25s cubic-bezier(0.4, 0, 0.2, 1); }
            ...
            .sparkle-icon { width: 14px; height: 14px; fill: currentColor; }
            ...
            @media (max-width: 1000px) { .grid, .f-grid { grid-template-columns: 1fr; } }
        </style>
    </head>
    <body>
        ...
        <div class="grid">
            ...
            <div class="card" style="border-color: rgba(255, 215, 0, 0.3);">
                <div class="ai-sparkles">
                    <svg class="sparkle-icon" viewBox="0 0 24 24"><path d="M12 2l2.4 7.2L22 12l-7.6 2.4L12 22l-2.4-7.2L2 12l7.6-2.4L12 2zM19 6l1.2 3.6L24 11l-3.8 1.2L19 16l-1.2-3.6L14 11l3.8-1.2L19 6zM6 16l.8 2.4L9 19l-2.2.8L6 22l-.8-2.4L3 19l2.2-.8L6 16z"/></svg>
                    AI Technology
                </div>
    ...
    <footer>
        <div class="f-grid">
            ...
            <div class="map-container">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3728.3965935324833!2d106.678175!3d20.856149!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x314a7af99d257077%3A0x95995540459c5d01!2zNTcgTMOqIFbEg24gVGh1eeG6v3QgQSwgQW4gQmnDqm4sIEzDqiBDaMOibiwgSOG6o2kgUGjDsm5n!5e0!3m2!1svi!2s!4v1715000000000" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
            </div>
        </div>
