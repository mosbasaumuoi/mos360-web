  ...
  async fetch(request, env) {
        ...
        if (link && link.startsWith('http')) {
          htmlContent += `
            <div class="student-item">
              <img src="${link}" onerror="this.src='https://via.placeholder.com/200x150?text=MOS360'">
            </div>`;
        }
      });
    ...
    <head>
        ...
        <style>
            ...
            * { box-sizing: border-box; margin: 0; padding: 0; }
            ...
            .student-item { width: 180px; flex-shrink: 0; } /* Tăng chiều rộng khung ảnh */
            .student-item img { 
                width: 100%; 
                aspect-ratio: 4/3; /* Tỷ lệ khung hình chữ nhật/vuông cho chứng chỉ */
                border-radius: 12px; 
                border: 2px solid var(--border); 
                object-fit: cover; 
                transition: 0.3s;
            }
            .student-item img:hover { border-color: var(--primary); transform: scale(1.05); }
            ...
            @media (max-width: 900px) { .main-container, .services-grid, .footer-content { grid-template-columns: 1fr; } .student-item { width: 140px; } }
        </style>
    </head>
    <body>
    ...
    <div class="services-grid">
        ...
        <div class="service-card">
            ...
            <p>AI hỗ trợ giải đáp kiến thức tin học và các hàm Excel phức tạp ngay tức thì.</p>
        </div>
        <div class="service-card">
    ...
    <footer>
        <div class="footer-content">
            ...
            <div class="map-container"><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3728.528434771485!2d106.6784332!3d20.8447477!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x314a7af2767098e9%3A0x6479633e970a2569!2zNTcgTMOqIFbEg24gVGh1eeG6v3QgQSwgQW4gQmnDqm4sIEzDqiBDaMOibiwgSOG6o2kgUGjDsm5n!5e0!3m2!1svi!2s!4v17150000000000" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy"></iframe></div>
        </div>
    </footer>
