export const IC3_LEVEL2 = [
  ...
  // ----- COMMUNICATION & COLLABORATION (7 câu) -----
  {
    id: 1,
    level: "IC3_LEVEL2",
    test: 1,
    ...
    explanation: "Khi tham gia họp trực tuyến, hai yếu tố môi trường vật lý quan trọng nhất là: Ánh sáng đầy đủ (để đảm bảo chất lượng webcam) và Sự yên tĩnh (tránh tiếng ồn tạp âm gây nhiễu micro)."
  },
  {
    id: 2,
    level: "IC3_LEVEL2",
    ...
    answer: "La hét",
    explanation: "Theo quy tắc ứng xử trên Internet (Netiquette), việc viết hoa toàn bộ các ký tự trong email hoặc tin nhắn được hiểu tương đương với hành vi 'la hét' vào mặt người đọc, thể hiện sự thô lỗ hoặc giận dữ."
  },
  {
    id: 3,
    level: "IC3_LEVEL2",
    ...
    explanation: "Sử dụng BCC giúp ẩn danh sách email người nhận, bảo vệ sự riêng tư. Xác thực 2FA tạo thêm lớp khóa bảo mật. Ngược lại, đăng giấy tờ định danh hoặc cấp quyền danh bạ vô tội vạ cho app lạ sẽ gây rủi ro bảo mật nghiêm trọng."
  },
  {
    id: 4,
    level: "IC3_LEVEL2",
    ...
    explanation: "Khi sử dụng loa ngoài (Speakerphone), âm thanh cuộc thoại sẽ bị phát ra không gian xung quanh và người khác có thể nghe thấy. Để tôn trọng quyền riêng tư cá nhân và bảo mật thông tin của người ở đầu dây bên kia, bạn luôn cần phải xin phép họ trước."
  },
  {
    id: 5,
    level: "IC3_LEVEL2",
  ...
  },
  {
    ...
    explanation: "Trong một buổi thảo luận/hội thảo trực tuyến (Webinar), cửa sổ Chat được thiết kế để người tham gia tương tác, gửi câu hỏi (Q&A) đến diễn giả hoặc ban tổ chức khi có thời điểm thích hợp, tránh làm gián đoạn hay loãng nội dung buổi học bằng các câu chuyện phiếm cá nhân."
  },
  {
    id: 7,
    level: "IC3_LEVEL2",
  ...
  },
  {
    ...
    options: ["Mã hóa (Encryption)", "Hàm băm (Hashing)", "Nén (Compression)", "Mã hóa ký tự (Encoding)"],
  ...
  // ----- PRODUCTIVITY SOFTWARE (5 câu) -----
  {
    ...
    options: ["Autocomplete", "Autofill", "Autocorrect", "Autofix"],
    answer: "Autocorrect",
  ...
  },
  {
    ...
    options: ["Ctrl + C", "Ctrl + V", "Ctrl + A", "Ctrl + Z"],
    answer: "Ctrl + A",
  ...
  },
  {
    ...
    options: ["Tự động chỉnh đúng (Autocorrect)", "Tự động hoàn thành (Autocomplete)", "Tự động tìm kiếm (Autosearch)", "Tự động sửa lỗi (Autofix)"],
    answer: "Tự động hoàn thành (Autocomplete)",
    explanation: "Khi gõ từ khóa tìm kiếm trên Google, hệ thống sẽ đưa ra các gợi ý cụm từ mở rộng dựa trên xu hướng tìm kiếm. Tính năng này được gọi là Google Autocomplete (Tự động hoàn thành) giúp tiết kiệm thời gian nhập liệu."
  },
  {
    id: 17,
    level: "IC3_LEVEL2",
  ...
  },
  {
    ...
    right: ["Sửa (Modify)", "Đọc & Thực thi (Read & Execute)", "Ghi (Write)", "Đọc (Read)"],
    answer: {
  ...
  },
  {
    ...
    explanation: "Bản chất của điện toán đám mây là lưu trữ và xử lý dữ liệu tập trung trên các hệ thống máy chủ từ xa chứ không phải máy cục bộ, và người dùng bắt buộc phải kết nối thông qua mạng Internet để truy cập."
  },
  {
    id: 27,
    level: "IC3_LEVEL2",
  ...
  // ----- HARDWARE (3 câu) -----
  {
    ...
    options: ["Độ sáng (Brightness)", "Nguồn đầu vào (Input Source)", "Độ tương phản (Contrast)", "Độ sắc nét (Sharpness)"],
  ...
  },
  {
    ...
    options: ["Bàn phím (Keyboard)", "Mic (Microphone)", "Loa (Speakers)", "Chuột máy tính (Mouse)"],
    answer: "Loa (Speakers)",
  ...
  // ----- OPERATING SYSTEM (3 câu) -----
  {
    ...
    options: ["Desktop", "Settings -> Personalization", "Settings -> Display", "Control Panel -> System"],
  ...
  },
  {
    ...
    options: ["Quản lý thiết bị đầu vào", "Tắt tiếng loa máy tính", "Đặt cấu hình cài đặt âm thanh trợ năng", "Quản lý thiết bị đầu ra"],
  ...
  // ----- TỪ LEVEL 3 CHUYỂN XUỐNG (8 câu - Test 1) -----
  {
    id: 44,
    level: "IC3_LEVEL2",
    test: 1,
    ...
    answer: "Lưu trữ thông tin phiên làm việc và tùy chọn của người dùng để cá nhân hóa trải nghiệm",
  ...
  },
  {
    ...
    answer: "Xóa email và không bao giờ nhấn vào liên kết",
  ...
  },
  {
    ...
    answer: "Kẻ tấn công xen vào giữa luồng giao tiếp giữa hai bên để đánh cắp hoặc thay đổi thông tin",
  ...
  },
  {
    ...
    options: [
      "Phần mềm được cung cấp qua Internet theo dạng thuê bao",
      "Phần cứng luôn được gửi về nhà",
      "Người dùng phải tự viết mã nguồn",
      "Dịch vụ sửa chữa phần cứng"
    ],
    answer: "Phần mềm được cung cấp qua Internet theo dạng thuê bao",
  ...
  },
  {
    ...
    answer: "Vì dữ liệu được lưu trữ ở các trung tâm dữ liệu xa vị trí địa lý của bạn",
  ...
  },
  {
    ...
    answer: "Yêu cầu phải có kết nối Internet liên tục để truy cập",
  ...
  },
  {
    ...
    answer: "HTTPS sử dụng mã hóa để bảo mật dữ liệu truyền tải",
  ...
  },
  {
    ...
    right: ["Bài đăng trên Blog", "Bài đăng trên diễn đàn", "Tin nhắn văn bản", "Email"],
    answer: {
  ...
  },
  {
    ...
    right: ["Bài đăng trên Blog (Blog post)", "Tin nhắn văn bản (Text message)", "Bài đăng trên diễn đàn (Forum post)", "Thư điện tử (Email message)"],
    answer: {
  ...
  },
  {
    ...
    answer: ["Tin nhắn tức thời (IM - Instant Messaging)", "Tin nhắn văn bản di động (SMS / Text message)"],
    explanation: "Đối với các thông điệp ngắn gọn và cần trao đổi nhanh, Tin nhắn tức thời (IM như Messenger, Zalo, Teams) và Tin nhắn văn bản (SMS) là hai lựa chọn tối ưu nhất. Ngược lại, Email thường dùng cho thông điệp dài, chính thức; Hội nghị truyền hình dùng cho thảo luận chuyên sâu trực diện."
  },
  ...
  },
  {
    ...
    difficulty: "hard",
    type: "multiple",
    question: "Khi xây dựng chính sách bảo mật cho doanh nghiệp, doanh nghiệp cần tuân thủ những quy định nào? (Chọn 3)",
    options: [
      "Đào tạo nhân viên về an toàn thông tin định kỳ",
      "Cho phép nhân viên sử dụng mật khẩu cá nhân cho tài khoản công ty",
      "Thiết lập chính sách mật khẩu mạnh",
      "Không cần sao lưu dữ liệu vì đã có bảo mật",
    ...
    explanation: "Ba trụ cột của bảo mật doanh nghiệp: (1) Đào tạo con người — nhân tố quan trọng nhất, (2) Chính sách kỹ thuật — mật khẩu và quyền truy cập, (3) Kiểm tra định kỳ — đánh giá lỗ hổng. Không nên dùng mật khẩu cá nhân cho công việc và luôn sao lưu dữ liệu."
  },
  {
    id: 62,
    level: "IC3_LEVEL2",
    ...
    answer: "Keylogger hoặc phần mềm độc hại có thể ghi lại thông tin đăng nhập của bạn",
  ...
  },
  {
    ...
    answer: "Phát hiện, ngăn chặn và loại bỏ phần mềm độc hại",
  ...
  },
  {
    ...
    answer: ["Mã hóa dữ liệu truyền tải giữa thiết bị và internet", "Ẩn địa chỉ IP thực của người dùng"],
  ...
  },
  {
    ...
    options: ["Enter", "Shift + Enter", "Tab", "Shift + Tab"],
    answer: "Enter",
  ...
  },
  {
    ...
    answer: {
      ...
      "Bạn có thể thay đổi căn lề (Margins) của tài liệu trực tiếp ngay trong phần cài đặt in (Print Settings)": "Sai",
  ...
  },
  {
    ...
    difficulty: "easy",
    type: "matching",
    question: "Quan sát hình ảnh mô phỏng định dạng trang giấy và thực hiện kéo thả vào đúng hướng trang tương ứng.",
    left: ["ic3_lv2_q68_opt_a", "ic3_lv2_q68_opt_b"],
    right: ["Khổ ngang (Landscape)", "Khổ dọc (Portrait)"],
    answer: {
      "ic3_lv2_q68_opt_a": "Khổ dọc (Portrait)",
      "ic3_lv2_q68_opt_b": "Khổ ngang (Landscape)"
    },
    explanation: "Trong soạn thảo văn bản và in ấn, hướng trang giấy gồm hai loại cơ bản: Khổ dọc (Portrait) có chiều cao lớn hơn chiều rộng, còn Khổ ngang (Landscape) có chiều rộng lớn hơn chiều cao."
  },

  // ----- DATA MANAGEMENT (4 câu) -----
  {
    id: 69,
    level: "IC3_LEVEL2",
    test: 2,
    ...
    options: ["Copy và Paste", "Cut và Paste", "Share và Link", "Send to Downloads"],
    answer: "Cut và Paste",
  ...
  },
  {
    ...
    options: ["Đọc (Read)", "Liệt kê danh mục (List folder contents)", "Xem hiển thị (View)", "Đọc - Ghi (Read-Write / Modify)"],
  ...
  // ----- CLOUD SERVICES (4 câu) -----
  {
    ...
    explanation: "Điện toán đám mây cung cấp khả năng lưu trữ linh hoạt từ xa qua Internet và được tự động cập nhật phần mềm. Tuy nhiên, lưu trữ đám mây an toàn hơn lưu trữ cục bộ (tránh hỏng ổ cứng vật lý) và thỉnh thoảng vẫn có thể gặp sự cố gián đoạn hệ thống (downtime) của nhà cung cấp."
  },
  {
    id: 74,
    level: "IC3_LEVEL2",
  ...
  },
  {
    ...
    right: ["Người bán (Merchant)", "Ngân hàng thanh toán", "Nhà phát hành (Issuer)"],
    answer: {
  ...
  },
  {
    ...
    options: ["Tông màu màn hình (Screen tone)", "Độ tương phản (Contrast)", "Độ tối (Darkness)", "Độ sáng (Brightness)"],
  ...
  // ----- OPERATING SYSTEM (4 câu) -----
  {
    ...
    options: ["Personalization", "Devices", "System", "Privacy"],
    answer: "System",
  ...
  },
  {
    ...
    options: ["File Explorer", "Windows Search (Search Box)", "Task Manager", "Control Panel"],
  ...
  },
  {
    ...
    options: ["Bộ nhớ đệm (Cache)", "Bộ nhớ ảo (Virtual Memory / Paging File)", "Bộ nhớ ROM", "Phân vùng phục hồi (Recovery Partition)"],
  ...
  },
  {
    ...
    options: ["Kích cỡ chữ (Size)", "Độ tương phản (Contrast)", "Màu sắc chữ và nền (Color)", "Kiểu chữ nghệ thuật (Font)"],
    answer: ["Kích cỡ chữ (Size)", "Độ tương phản (Contrast)", "Màu sắc chữ và nền (Color)"],
  ...
  // ----- TỪ LEVEL 3 CHUYỂN XUỐNG (8 câu - Test 2) -----
  {
    id: 94,
    level: "IC3_LEVEL2",
    test: 2,
    ...
    answer: "Tấn công vào tâm lý con người để thao túng cung cấp thông tin",
  ...
  },
  {
    ...
    answer: "Làm quá tải hệ thống khiến dịch vụ ngừng hoạt động",
  ...
  },
  {
    ...
    answer: "Chỉ người gửi và người nhận mới có thể đọc được tin nhắn",
  ...
  },
  {
    ...
    answer: "Vì sao lưu giúp bạn khôi phục lại dữ liệu gốc mà không cần phải trả tiền chuộc cho tin tặc",
  ...
  },
  {
    ...
    answer: "Tính bảo mật, chính sách bảo mật và uy tín của nhà cung cấp",
  ...
  },
  {
    ...
    answer: "3 bản sao, 2 phương tiện khác nhau, 1 bản lưu trữ bên ngoài (offsite)",
  ...
  },
  {
    ...
    answer: "Tốc độ tối đa mà dữ liệu có thể truyền qua một kết nối mạng trong một đơn vị thời gian",
  ...
  // ============================================================
  // TEST 3 (45 câu) - BỔ SUNG 34 CÂU
  // ============================================================

  // ----- COMMUNICATION & COLLABORATION (8 câu) -----
  {
    id: 102,
    level: "IC3_LEVEL2",
    test: 3,
    ...
    explanation: "Mục đích cốt lõi của một đợt thực tập (đặc biệt là thực tập không lương khi còn là học sinh/sinh viên) là học hỏi thêm kỹ năng thực tế và vận dụng kiến thức trường học vào môi trường chuyên nghiệp. Sinh viên thực tập chưa đủ trình độ và thẩm quyền để đi đào tạo lại nhân viên chính thức hoặc làm quản lý giám sát nhân sự."
  },
  {
    id: 103,
    level: "IC3_LEVEL2",
  ...
  },
  {
    ...
    explanation: "Trường Bcc (Blind Carbon Copy) được thiết kế với mục đích bảo mật quyền riêng tư, giúp ẩn danh sách địa chỉ email của những người nhận được điền trong trường này, khiến họ không thể nhìn thấy email của nhau."
  },
  {
    id: 105,
    level: "IC3_LEVEL2",
    ...
    right: ["Có tuân thủ", "Không tuân thủ"],
    answer: {
      ...
      "\"Đây là một việc làm sai lầm và khiến bạn trông thật ngớ ngẩn! Rõ ràng là bạn không hề tìm hiểu kỹ thông tin từ Harvard Medical School!\"": "Không tuân thủ",
      "\"SAI RỒI! Bạn có TÌM HIỂU KỸ trước khi đăng bài viết này lên mạng không hả?\"": "Không tuân thủ"
    },
    explanation: "Chuẩn mực đạo đức số (Netiquette) yêu cầu chúng ta phản biện dựa trên sự tôn trọng, đưa ra thông tin khách quan hoặc dẫn nguồn uy tín. Việc sử dụng ngôn từ xúc phạm ('trông thật ngớ ngẩn'), viết hoa toàn bộ thể hiện thái độ la hét giận dữ ('SAI RỒI!') là hành vi vi phạm chuẩn mực ứng xử văn minh trực tuyến."
  },
  {
    id: 106,
    level: "IC3_LEVEL2",
    ...
    explanation: "Bộ định tuyến mạng và tai nghe Bluetooth là các thực thể phần cứng vật lý cầm nắm được nên thuộc về 'Hàng hóa'. Lưu trữ đám mây và gói đăng ký phần mềm là các giải pháp điện toán, tiện ích công nghệ được cung cấp qua Internet nên thuộc về 'Dịch vụ'."
  },
  {
    id: 107,
    level: "IC3_LEVEL2",
    ...
    right: ["Cả ngày (All day)", "Tùy chỉnh thông báo", "Lặp lại hàng năm (Repeat / Annually)", "Mời người tham dự (Invite attendees)"],
    answer: {
      "Xoá mốc thời gian bắt đầu và kết thúc cụ thể của sự kiện trong ngày": "Cả ngày (All day)",
      "Cài đặt nhận thông báo nhắc nhở một tuần trước khi sự kiện diễn ra để kịp chuẩn bị mua quà": "Tùy chỉnh thông báo",
  ...
  },
  {
    ...
    right: ["Blog", "Tin nhắn văn bản", "Diễn đàn", "Email"],
    answer: {
      "Chia sẻ những dòng suy nghĩ, quan điểm hoặc trải nghiệm cá nhân hàng ngày lên một cuốn nhật ký trực tuyến mở cho mọi người cùng đọc": "Blog",
      "Nhắn nhanh cho người thân để báo địa điểm cụ thể họ sẽ qua đón bạn sau giờ làm": "Tin nhắn văn bản",
      "Đặt một câu hỏi công khai vào nhóm trực tuyến để thảo luận, tiếp nhận ý kiến đóng góp về một trò chơi điện tử": "Diễn đàn",
      "Gửi một văn bản chính thức yêu cầu bộ phận chăm sóc khách hàng của một công ty thực hiện hoàn trả lại tiền": "Email"
    },
    explanation: "Viết nhật ký cá nhân dài hạn công khai là tính năng của Blog; thông báo khẩn, ngắn gọn là Tin nhắn văn bản (Text/SMS); diễn đàn (Forum) dùng cho việc thảo luận nhóm chung cùng chủ đề; và trao đổi chính thức về mặt thương mại, thủ tục là Email."
  },
  ...
  },
  {
    ...
    explanation: "Windows 10 có một tùy chọn cài đặt hệ thống tập trung (nằm trong Settings > Devices > Typing) mang tên 'Autocorrect misspelled words'. Nó áp dụng đồng bộ cho toàn hệ thống chứ không hoàn toàn bị phân mảnh cô lập riêng lẻ độc lập trên từng ứng dụng mặc định."
  },
  {
    id: 118,
    level: "IC3_LEVEL2",
  ...
  // ----- ONLINE SAFETY (2 câu) -----
  {
    ...
    answer: "Xóa hoàn toàn tài khoản (Account Deletion) thay vì chỉ gỡ ứng dụng",
