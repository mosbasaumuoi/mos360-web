export const IC3_LEVEL3 = [
  ...
  },
  {
    ...
    difficulty: "medium",
    type: "single",
    question: "Việc tắt các dịch vụ nền (background services) không cần thiết trên hệ điều hành có tác dụng gì?",
    options: [
      "Giảm tiêu thụ tài nguyên (CPU, RAM) và tăng hiệu suất",
      "Làm cho màn hình đẹp hơn",
      "Làm hỏng ổ cứng",
      "Không có tác dụng gì"
    ],
    answer: 0,
    explanation: "Nhiều dịch vụ chạy ngầm chiếm dụng tài nguyên hệ thống. Tắt các dịch vụ này giúp giải phóng tài nguyên cho các ứng dụng ưu tiên."
  },
  {
    id: 30,
    level: "IC3_LEVEL3",
  ...
  },
  {
    ...
    options: ["Khả năng mở rộng tài nguyên linh hoạt", "Giảm chi phí đầu tư phần cứng ban đầu", "Yêu cầu phải có kết nối Internet liên tục để truy cập", "Tự động cập nhật phần mềm"],
    answer: 2,
  ...
  },
  {
    ...
    difficulty: "medium",
    type: "single",
    question: "Tốc độ mạng bị chậm có thể do nguyên nhân nào sau đây?",
    options: ["Đường truyền bị tắc nghẽn hoặc quá nhiều thiết bị dùng chung", "Do máy tính quá sạch", "Do màn hình máy tính có độ phân giải cao", "Do dùng bàn phím có dây"],
    answer: 0,
    explanation: "Băng thông là hữu hạn. Khi nhiều thiết bị tải dữ liệu nặng cùng lúc, tốc độ cho mỗi thiết bị sẽ giảm xuống."
  },
  {
    id: 38,
    level: "IC3_LEVEL3",
  ...
  },
  {
    ...
    difficulty: "medium",
    type: "single",
    question: "Lệnh 'Reset and clean up' trong cài đặt Google Chrome có tác dụng gì?",
    options: ["Xóa lịch sử và đưa cài đặt trình duyệt về trạng thái mặc định ban đầu", "Xóa toàn bộ ổ cứng máy tính", "Chỉ làm đổi màu giao diện", "Chỉ làm tăng tốc độ tải trang"],
    answer: 0,
  ...
  },
  {
    ...
    difficulty: "medium",
    type: "single",
    question: "Khái niệm 'Edge Computing' trong IoT là gì?",
    options: ["Xử lý dữ liệu tại gần thiết bị nguồn thay vì gửi lên đám mây trung tâm", "Chỉ gửi dữ liệu lên đám mây", "Không xử lý dữ liệu", "Làm cho máy tính nhanh hơn"],
    answer: 0,
    explanation: "Edge Computing giúp giảm độ trễ (latency) bằng cách xử lý dữ liệu ngay tại thiết bị IoT thay vì phải gửi tất cả lên server đám mây."
  },
  {
    id: 49,
    level: "IC3_LEVEL3",
  ...
  },
  {
    ...
    difficulty: "medium",
    type: "single",
    question: "SaaS, PaaS và IaaS là ba mô hình dịch vụ chính của cái gì?",
    options: ["Điện toán đám mây (Cloud Computing)", "Phần cứng máy tính", "Lập trình ngôn ngữ C", "Mạng điện lưới"],
    answer: 0,
    explanation: "Đây là 3 cấp độ dịch vụ phổ biến của Cloud, tùy thuộc vào việc bạn thuê toàn bộ hạ tầng (IaaS) hay chỉ thuê ứng dụng (SaaS)."
  },
  {
    id: 55,
    level: "IC3_LEVEL3",
    ...
    options: ["Sử dụng hình ảnh cắt ghép không khớp với nội dung", "Dẫn nguồn từ các cơ quan thông tấn uy tín", "Tiêu đề gây sốc, thiếu kiểm chứng", "Nội dung được xác thực bởi nhiều bên"],
    answer: [0, 2],
  ...
  },
  {
    ...
    options: ["Có thể bị khóa tài khoản, bị cộng đồng tẩy chay và ảnh hưởng danh tiếng cá nhân", "Được nhiều người hâm mộ", "Không gây ra hậu quả gì", "Làm cho máy tính nhanh hơn"],
    answer: 0,
  ...
  },
  {
    ...
    options: ["Dữ liệu luôn được cập nhật phiên bản mới nhất trên mọi thiết bị bạn đăng nhập", "Làm mất dữ liệu", "Không có tác dụng gì", "Chỉ làm tăng hóa đơn tiền điện"],
    answer: 0,
  ...
  },
  {
    ...
    difficulty: "medium",
    type: "single",
    question: "Thuật ngữ 'Algorithmic Bias' (Thiên kiến thuật toán) chỉ điều gì?",
    options: ["Sự bất công trong kết quả của AI do dữ liệu hoặc thiết kế thuật toán", "AI chạy nhanh quá mức", "AI làm đẹp hình ảnh", "AI tự viết code"],
    answer: 0,
  ...
  },
  {
    ...
    options: [
      "Sử dụng AI hiệu quả",
      "Thiên kiến thuật toán (Algorithmic Bias) dựa trên dữ liệu không công bằng",
      "AI đang làm việc đúng quy trình",
      "AI đang giúp tiết kiệm thời gian cho công ty"
    ],
    answer: 1,
    explanation: "Việc sử dụng địa chỉ cư trú làm tiêu chí loại hồ sơ là hành vi phân biệt đối xử (gián tiếp), cho thấy thuật toán đã bị thiên kiến bởi dữ liệu huấn luyện hoặc cách thiết lập biến số không công bằng."
  },
  {
    id: 83,
    level: "IC3_LEVEL3",
