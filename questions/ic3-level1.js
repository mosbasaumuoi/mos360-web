export const IC3_LEVEL1 = [
  ...
  },
  {
    ...
    category: "NETWORK",
    difficulty: "medium",
    type: "matching", // Chuyển đổi từ dạng bảng sang dạng matching cho tối ưu
  ...
  },
  {
    ...
    options: [
      ...
      "Thử lưu một tập tin",
      "Mở trình duyệt web để truy cập một trang web bất kỳ",
      "Hãy thử gửi một tin nhắn SMS thông thường"
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "Máy tính xách tay chạy Windows (Laptop)",
  ...
  },
  {
    ...
    options: [
      "Duyệt đa trang một lúc (Multi-tabbing)",
      "Mục yêu thích hoặc đánh dấu trang (Favorites/Bookmarks)",
      "Lịch sử hoặc dòng thời gian (History/Timeline)",
  ...
  },
  {
    ...
    right: [
      "Ổ đĩa cứng (HDD)",
      "Ổ cứng di động (External HDD/SSD)",
      "Ổ đĩa flash USB",
      "Ổ cứng thể rắn (SSD)"
    ],
    answer: {
  ...
  },
  {
    ...
    difficulty: "easy",
    type: "single",
    question: "Bạn đang xem một bài báo nghiên cứu trực tuyến rất dài trên trình duyệt web. Bạn có thể tìm thấy thông tin nào một cách nhanh nhất bằng cách sử dụng tính năng Tìm kiếm (Ctrl + F) của trình duyệt?",
    options: [
      "Các bình luận liên quan đến bài viết đó trên các trang mạng xã hội bên ngoài",
      "Danh sách các chủ đề phụ liên quan đến chủ đề nghiên cứu chính của bạn",
      "Số lần xuất hiện hoặc vị trí chính xác của một từ khóa/chủ đề cụ thể trong văn bản bài báo",
      "Đáp án chọn lọc cho một câu hỏi tự luận phức tạp liên quan đến chủ đề bài viết"
    ],
    answer: "Số lần xuất hiện hoặc vị trí chính xác của một từ khóa/chủ đề cụ thể trong văn bản bài báo",
  ...
  },
  {
    ...
    difficulty: "medium",
    type: "single",
    question: "Bạn cần tuân thủ các tiêu chuẩn đạo đức trực tuyến để bảo vệ danh tiếng kỹ thuật số của bản thân. Hành động nào dưới đây đáp ứng đúng yêu cầu này?",
    options: [
      "Cải thiện phần kinh nghiệm làm việc trực tuyến bằng cách viết thêm các nhiệm vụ bạn dự định sẽ hoàn thành trong tương lai",
      "Sử dụng tự do bất kỳ hình ảnh nào tìm thấy trên Google cho trang web thương mại của công ty bạn",
      "Luôn luôn tuân thủ nghiêm túc các điều khoản trong chính sách sử dụng được chấp nhận (AUP) khi sử dụng wi-fi công cộng của nhà trường",
      "Đính kèm toàn bộ file bản quyền của một bài hát nổi tiếng vào video cá nhân công khai trên mạng xã hội mà không xin phép"
    ],
  ...
  
  {
    ...
    answer: {
      ...
      "Bạn diễn đạt lại (Paraphrase) nội dung từ một bài viết trên tạp chí khoa học": "Có", // Đã đính chính logic chuẩn (Sách gốc bị lệch đáp án trực quan)
  ...
  },
  {
    ...
    options: [
      "Tạo một đĩa sửa lỗi hệ thống (System Repair Disc)",
      "Tạo ảnh hệ thống (Create a System Image)",
      "Thiết lập trình sao lưu thông thường của Windows (Windows Backup)",
      "Bật tính năng Lịch sử tập tin (File History)"
    ],
  ...
  {
    id: 53, // Tương ứng Câu 8 - Test 2
    level: "IC3_LEVEL1",
    test: 2,
    category: "SOFTWARE",
    difficulty: "medium",
    type: "single",
    question: "Bạn chụp ảnh kỷ yếu cho trường bằng điện thoại với số lượng hơn 50 bức ảnh mỗi ngày. Bạn cần sử dụng phương pháp nhanh nhất và đáng tin cậy nhất để sao lưu các bức ảnh và giải phóng bộ nhớ, xóa chúng khỏi điện thoại định kỳ mỗi ngày. Phương án tối ưu là gì?",
    options: [
      "Chỉ lựa chọn và xóa những ảnh bạn không muốn sử dụng nữa",
      "Đồng bộ hóa điện thoại của bạn trực tiếp với dịch vụ lưu trữ đám mây",
      "Kết nối bằng dây cáp để tải toàn bộ ảnh xuống ổ flash USB",
      "Gửi đính kèm ảnh qua email cá nhân cho giáo viên của bạn"
    ],
    answer: "Đồng bộ hóa điện thoại của bạn trực tiếp với dịch vụ lưu trữ đám mây",
    explanation: "Tính năng tự động đồng bộ hóa lên đám mây (Cloud Synchronization) là phương pháp tự động, nhanh nhất và an toàn giúp bảo vệ ảnh lập tức, sau đó người dùng có thể xóa ảnh ở thiết bị cục bộ để giải phóng không gian lưu trữ."
  },
  {
    id: 54, // Tương ứng Câu 9 - Test 2
    level: "IC3_LEVEL1",
    test: 2,
    category: "DIGITAL_CITIZENSHIP",
    difficulty: "easy",
  ...
  },
  {
    ...
    options: [
      ...
      "Sự sáng tạo/Tác phẩm sáng tạo (Creation)"
    ],
  ...
  },
  {
    ...
    options: [
      "Am hiểu công nghệ (Tech savvy)",
      "Có trách nhiệm (Responsible)",
      "Chuyên nghiệp (Professional)",
      "Không chuyên nghiệp (Unprofessional)"
    ],
  ...
  
  {
    ...
    left: [
      "Nội dung trang web được trình bày và viết một cách hoàn toàn khách quan, không thiên vị",
      "Trang web bao gồm và trích dẫn rõ ràng một danh sách các nguồn tài liệu tham khảo uy tín",
      "Trang web xuất hiện nhiều lỗi sai chính tả, lỗi dịch thuật và diễn đạt lủng củng"
    ],
    right: [
      "Có",
      "Không"
    ...
    answer: {
      "Nội dung trang web được trình bày và viết một cách hoàn toàn khách quan, không thiên vị": "Có",
      "Trang web bao gồm và trích dẫn rõ ràng một danh sách các nguồn tài liệu tham khảo uy tín": "Có",
  ...
  },
  {
    ...
    difficulty: "hard",
    type: "matching",
    question: "Bạn đang nghiên cứu thông tin trong một tài liệu văn bản rất dài. Với mỗi tác vụ dưới đây, hãy chọn Có nếu bạn có thể sử dụng tính năng Tìm kiếm/Thay thế thông thường (Find/Replace) của ứng dụng để hoàn thành hoặc chọn Không nếu không thể:",
    left: [
      "Xác định các trang có chứa thông tin tài liệu tham khảo của một tác giả cụ thể",
      "Định vị nhanh vị trí xuất hiện của một từ khóa hoặc cụm từ cụ thể trong văn bản",
      "Tự động thay đổi định dạng (kiểu trích dẫn) của tất cả các trích dẫn trong tài liệu sang một chuẩn mới (ví dụ từ APA sang MLA)"
    ],
    right: [
      "Có",
      "Không"
    ...
    answer: {
      "Xác định các trang có chứa thông tin tài liệu tham khảo của một tác giả cụ thể": "Có",
      "Định vị nhanh vị trí xuất hiện của một từ khóa hoặc cụm từ cụ thể trong văn bản": "Có",
      "Tự động thay đổi định dạng (kiểu trích dẫn) của tất cả các trích dẫn trong tài liệu sang một chuẩn mới (ví dụ từ APA sang MLA)": "Không"
    },
    explanation: "Tính năng Tìm kiếm (Find) giúp tìm ra vị trí của từ khóa (tên tác giả, cụm từ) trong văn bản. Tuy nhiên, việc tự động đổi toàn bộ định dạng hệ thống trích dẫn học thuật từ chuẩn này sang chuẩn khác đòi hỏi công cụ quản lý trích dẫn chuyên dụng, tính năng Tìm/Thay thế thông thường không tự làm được."
  },
  {
    id: 64, // Tương ứng Câu 19 - Test 2
    level: "IC3_LEVEL1",
    test: 2,
    category: "DIGITAL_CITIZENSHIP",
    difficulty: "hard",
  ...
  },
  {
    ...
    options: [
      ...
      "SamGreyv3.docx",
      "Sam_Grey_Project1_version3.docx",
  ...
  },
  {
    ...
    options: [
      "Đồng tác giả (Co-authoring)",
      "Bình duyệt/Đánh giá ngang hàng (Peer review)",
      "Quy kết nguồn (Attribution)",
      "Xác minh dữ kiện (Fact checking)"
    ],
  ...
  },
  {
    ...
    options: [
      ...
      "Tên nhà xuất bản (Publisher's name)",
      "Ngày ký và nộp lệ phí bản quyền (Copyright date)",
      "Tên sách (Book title)",
      "Ngày xuất bản/Năm xuất bản (Publication date)"
    ],
    answer: [
      "Tên tác giả (Author's name)",
      "Tên sách (Book title)",
  ...
  },
  {
    ...
    options: [
      "Tường lửa (Firewalls)",
      "Lưới an toàn kỹ thuật số (Safety Nets)",
      "Phần mềm độc hại giả lập (Malware)",
  ...
  },
  {
    ...
    answer: {
      ...
      "Chủ sở hữu bản quyền quên hoặc không thực hiện đúng quy trình gia hạn thời gian bảo hộ bản quyền": "Sai", // Luật hiện đại tự bảo hộ tự động kéo dài theo đời người, không cần làm thủ tục gia hạn định kỳ như xưa.
  ...
  {
    id: 79, // Tương ứng Câu 34 - Test 2 (Đoạn đầu câu tiếp theo)
    level: "IC3_LEVEL1",
    test: 2,
    category: "DIGITAL_CITIZENSHIP",
    difficulty: "medium",
  ...
  
  {
    ...
    difficulty: "medium",
    type: "matching",
    question: "Bạn muốn bảo vệ thông tin khi lướt web trên máy tính dùng chung ở thư viện. Với mỗi câu phát biểu về tính năng duyệt web ở chế độ riêng tư (Private/Incognito), hãy chọn Đúng hoặc Sai:",
    left: [
      "Lịch sử duyệt web (Browsing History) của người dùng sẽ không bị lưu trữ lại trên máy tính sau khi đóng cửa sổ",
      "Hệ thống sẽ hoàn toàn ngăn chặn nhà mạng hoặc quản trị viên mạng theo dõi các gói tin bạn gửi đi",
      "Các cookie được tạo ra trong phiên làm việc sẽ tự động bị xóa bỏ khi bạn thoát khỏi chế độ này"
    ],
    right: [
      "Đúng",
      "Sai"
    ...
    answer: {
      "Lịch sử duyệt web (Browsing History) của người dùng sẽ không bị lưu trữ lại trên máy tính sau khi đóng cửa sổ": "Đúng",
      "Hệ thống sẽ hoàn toàn ngăn chặn nhà mạng hoặc quản trị viên mạng theo dõi các gói tin bạn gửi đi": "Sai",
      "Các cookie được tạo ra trong phiên làm việc sẽ tự động bị xóa bỏ khi bạn thoát khỏi chế độ này": "Đúng"
    },
    explanation: "Duyệt web riêng tư giúp xóa lịch sử, tệp tạm và cookie cục bộ trên thiết bị đó sau khi đóng tab, giúp người dùng chung máy không thấy được hoạt động của bạn. Tuy nhiên, nó không thể ẩn dữ liệu trước nhà mạng hoặc quản trị viên hệ thống mạng lớp học/công ty."
  },
  {
    id: 82, // Chuyển giao sang Test 1 - Câu 22 (Về thiết lập mật khẩu mạnh)
    level: "IC3_LEVEL1",
    test: 1,
    category: "DIGITAL_CITIZENSHIP",
    difficulty: "easy",
  ...
  {
    id: 84, // Tương ứng Test 1 - Câu 24
    level: "IC3_LEVEL1",
    test: 1,
    category: "SOFTWARE",
    difficulty: "medium",
    type: "matching",
    question: "Hãy ghép nối các công cụ cơ bản của trình duyệt web (Browser tools) với hành động mô tả chức năng tương ứng:",
    left: [
      "Nơi hiển thị và cho phép người dùng nhập trực tiếp địa chỉ URL của trang web hiện tại",
      "Tải lại dữ liệu của trang web hiện tại để cập nhật thông tin mới nhất",
      "Liệt kê danh sách các trang web mà người dùng đã truy cập gần đây theo mốc thời gian",
      "Quay trở lại nhanh trang web liền trước vừa truy cập trong tab hiện tại"
    ],
    right: [
      "Hộp địa chỉ (Address box)",
      "Nút tải lại (Refresh button)",
      "Lịch sử duyệt web (History)",
      "Nút quay lại (Back button)"
    ],
    answer: {
      "Nơi hiển thị và cho phép người dùng nhập trực tiếp địa chỉ URL của trang web hiện tại": "Hộp địa chỉ (Address box)",
      "Tải lại dữ liệu của trang web hiện tại để cập nhật thông tin mới nhất": "Nút tải lại (Refresh button)",
      "Liệt kê danh sách các trang web mà người dùng đã truy cập gần đây theo mốc thời gian": "Lịch sử duyệt web (History)",
      "Quay trở lại nhanh trang web liền trước vừa truy cập trong tab hiện tại": "Nút quay lại (Back button)"
    },
    explanation: "Address box chứa URL; Refresh giúp nạp lại trang; History lưu lịch sử truy cập; Back quay lại trang vừa xem trước đó."
  },
  {
    id: 85, // Tương ứng Test 1 - Câu 25
    level: "IC3_LEVEL1",
    test: 1,
    category: "HARDWARE",
    difficulty: "easy",
    ...
    options: [
      "Tải xuống và cài đặt thêm một ứng dụng bên thứ ba như Speedtest",
      "Thử thực hiện lưu (Save) một tập tin văn bản cục bộ lên ổ đĩa cứng",
      "Mở trình duyệt web bất kỳ lên và thử truy cập vào một trang web phổ thông",
      "Thử mở ứng dụng soạn thảo để viết và gửi tin nhắn SMS nội bộ"
    ],
  ...
  {
    id: 86, // Tương ứng Test 1 - Câu 26
    level: "IC3_LEVEL1",
    test: 1,
    category: "DIGITAL_CITIZENSHIP",
    difficulty: "hard",
    type: "multiple",
    question: "Bạn cần bảo vệ an toàn tối đa cho hệ thống mật khẩu quản trị cá nhân của mình. Đâu là ba nguyên tắc bạn cần tuân thủ? (Chọn 3)",
    options: [
      "Sử dụng các mật khẩu hoàn toàn khác nhau cho mỗi tài khoản trực tuyến riêng biệt",
      "Ghi chép toàn bộ mật khẩu phức tạp vào một cuốn sổ tay nhỏ và luôn mang theo bên mình",
      "Kích hoạt và sử dụng tính năng xác thực đa yếu tố (MFA / 2FA) bất cứ khi nào hệ thống hỗ trợ",
      "Sử dụng độ dài mật khẩu dài nhất hoặc các cụm mật khẩu (Passphrase) được hệ thống cho phép",
      "Sử dụng các từ vựng thông thường dễ tìm thấy trong cuốn từ điển của một ngôn ngữ nước ngoài"
    ],
    answer: [
      "Sử dụng các mật khẩu hoàn toàn khác nhau cho mỗi tài khoản trực tuyến riêng biệt",
      "Kích hoạt và sử dụng tính năng xác thực đa yếu tố (MFA / 2FA) bất cứ khi nào hệ thống hỗ trợ",
    ...
    explanation: "Việc không dùng chung một mật khẩu giúp tránh rủi ro sập dây chuyền tài khoản. MFA thêm một lớp bảo mật điện thoại, và Passphrase (cụm mật khẩu dài) làm tăng độ phức tạp chống lại các cuộc tấn công vét cạn (Brute-force)."
  },
  {
    id: 87, // Tương ứng Test 1 - Câu 27
    level: "IC3_LEVEL1",
    test: 1,
    category: "HARDWARE",
    difficulty: "medium",
  ...
  {
    id: 88, // Tương ứng Test 1 - Câu 28
    level: "IC3_LEVEL1",
    test: 1,
    category: "DIGITAL_CITIZENSHIP",
    difficulty: "easy",
    type: "matching",
    question: "Thông tin nhận dạng cá nhân (PII) là những dữ liệu nhạy cảm có thể dùng để định danh trực tiếp một con người. Với mỗi loại thông tin sau, hãy chọn Có nếu đó là thông tin PII cần bảo vệ nghiêm ngặt hoặc Không nếu không phải:",
    left: [
      "Ngày tháng năm sinh cụ thể của bạn (Date of birth)",
      "Màu mắt tự nhiên của bạn (Eye color)",
      "Nơi sinh / Thành phố nơi bạn được sinh ra (Place of birth)"
    ],
    right: [
      "Có",
      "Không"
    ...
    answer: {
      "Ngày tháng năm sinh cụ thể của bạn (Date of birth)": "Có",
      "Màu mắt tự nhiên của bạn (Eye color)": "Không",
      "Nơi sinh / Thành phố nơi bạn được sinh ra (Place of birth)": "Có"
    },
    explanation: "Ngày sinh và nơi sinh là những thông tin định danh pháp lý cốt lõi, thường dùng trong các câu hỏi bảo mật ngân hàng hoặc giấy tờ hành chính (thuộc PII). Màu mắt là đặc điểm nhân trắc học chung chung, không đủ cơ sở để định danh hay giả mạo danh tính cá nhân trên môi trường số."
  },
  {
    id: 89, // Tương ứng Test 1 - Câu 30
    level: "IC3_LEVEL1",
    test: 1,
    category: "DIGITAL_CITIZENSHIP",
    difficulty: "easy",
    type: "single",
    question: "Khi bạn mượn máy tính của người khác và kích hoạt tính năng Duyệt web ẩn danh / riêng tư (Private Browsing), cơ chế này đảm bảo điều gì cho dữ liệu của bạn?",
    options: [
      "Mật khẩu của bạn sẽ tự động được đồng bộ và lưu trữ vào đám mây mà không cần thay đổi",
      "Toàn bộ lịch sử duyệt web, các trang web đã xem và cookie trong phiên làm việc sẽ không bị lưu lại trên thiết bị",
      "Mọi thông tin đăng nhập tài khoản ngân hàng sẽ được lưu vĩnh viễn để tiện dùng cho lần sau",
      "Máy tính sẽ tự động giải phóng bộ nhớ để tạo ra nhiều dung lượng trống hơn trên ổ đĩa cứng"
    ],
    answer: "Toàn bộ lịch sử duyệt web, các trang web đã xem và cookie trong phiên làm việc sẽ không bị lưu lại trên thiết bị",
    explanation: "Bản chất cốt lõi của tính năng duyệt web ẩn danh (Incognito/Private) là bảo vệ sự riêng tư cục bộ: sau khi bạn tắt cửa sổ, mọi vết tích duyệt web gồm lịch sử truy cập và cookie sẽ biến mất khỏi máy tính đó."
  },
  {
    id: 90, // Tương ứng Test 1 - Câu 31
    level: "IC3_LEVEL1",
    test: 1,
    category: "HARDWARE",
    difficulty: "medium",
    type: "single",
    question: "Thiết bị mạng nào đóng vai trò cốt lõi trong việc chuyển đổi tín hiệu dữ liệu từ dạng kỹ thuật số (Digital) sang dạng tương tự (Analog) và ngược lại để truyền dẫn qua hệ thống dây cáp điện thoại hoặc truyền hình?",
    options: [
      "Cáp mạng Ethernet (Ethernet Cable)",
      "Thiết bị định tuyến (Router)",
      "Thiết bị điều chế và giải điều chế (Modem)",
      "Bộ điều hợp mạng / Card mạng (Network Adapter)"
    ],
 ...
 
  {
    ...
    difficulty: "medium",
    type: "matching",
    question: "Là một người sử dụng máy tính có đạo đức và trách nhiệm, bạn cần tuân thủ các quy tắc hành xử đúng mực trên mạng (Netiquette) tại môi trường làm việc văn phòng. Với mỗi câu phát biểu dưới đây, hãy chọn Có nếu đó là hành vi lịch sự, chuyên nghiệp hoặc Không nếu ngược lại:",
    left: [
      "Chia sẻ các tập tin có dung lượng rất lớn thông qua liên kết dịch vụ lưu trữ đám mây hoặc máy chủ dùng chung thay vì đính kèm trực tiếp vào email",
      "Luôn luôn sử dụng tính năng Cc (Carbon Copy) gửi cho tất cả đồng nghiệp trong công ty khi gửi bất kỳ email nào để họ nắm thông tin",
      "Áp dụng các tiêu chuẩn đạo đức và giá trị tôn trọng trong các tương tác trực tuyến tương tự như khi tương tác trực tiếp ngoài đời thực"
    ],
    right: [
      "Có",
      "Không"
    ...
    answer: {
      "Chia sẻ các tập tin có dung lượng rất lớn thông qua liên kết dịch vụ lưu trữ đám mây hoặc máy chủ dùng chung thay vì đính kèm trực tiếp vào email": "Có", // Lưu ý: Trong tài liệu gốc ghi nhận giá trị đối sánh đảo lại hoặc lỗi hiển thị dòng, nhưng xét theo chuẩn Netiquette quốc tế & IC3, gửi link đám mây thay vì đống file đính kèm nặng là hành vi chuẩn mực (Có).
      "Luôn luôn sử dụng tính năng Cc (Carbon Copy) gửi cho tất cả đồng nghiệp trong công ty khi gửi bất kỳ email nào để họ nắm thông tin": "Không", // Spam hòm thư toàn công ty là sai nghi thức
      "Áp dụng các tiêu chuẩn đạo đức và giá trị tôn trọng trong các tương tác trực tuyến tương tự như khi tương tác trực tiếp ngoài đời thực": "Có"
    },
    explanation: "Quy tắc Netiquette yêu cầu chia sẻ file lớn qua link đám mây để tránh nghẽn hòm thư người nhận, không lạm dụng nút Reply All/Cc cho những người không liên quan, và luôn giữ chuẩn mực đạo đức lịch sự như khi giao tiếp trực tiếp."
  },
  {
    id: 92, // Tương ứng Test 1 - Câu 33
    level: "IC3_LEVEL1",
    test: 1,
    category: "DIGITAL_CITIZENSHIP",
    difficulty: "medium",
    type: "single",
    question: "Lịch sử duyệt web và các trang web được đánh dấu cung cấp cho tin tặc (Hacker) một bản đồ lộ trình chi tiết về toàn bộ các tài khoản trực tuyến của bạn. Bên cạnh các trang web thường xuyên truy cập, hacker có thể chiếm đoạt và lợi dụng thành phần nào dưới đây để tự động đăng nhập trái phép vào tài khoản của bạn nếu mật khẩu được lưu sẵn trên thiết bị?",
    options: [
      "Tệp Cookie (Cookies)",
      "Mẫu cắt (Cutouts)",
      "Lịch sử hệ thống (History)",
      "Cài đặt hiển thị (Settings)"
    ],
    answer: "Tệp Cookie (Cookies)",
    explanation: "Cookies (đặc biệt là Session Cookies) lưu giữ trạng thái đăng nhập và thông tin phiên làm việc của người dùng. Nếu hacker chiếm được file cookie này cùng với mật khẩu đã lưu, chúng có thể dễ dàng vượt qua các bước xác thực để vào tài khoản."
  },
  {
    id: 93, // Tương ứng Test 1 - Câu 34
    level: "IC3_LEVEL1",
    test: 1,
    category: "SOFTWARE",
    difficulty: "easy",
    type: "single",
    question: "Bạn cần lưu giữ lại danh sách các địa chỉ trang web học tập hay trực tuyến phổ biến để có thể dễ dàng truy cập lại nhanh chóng trong những lần sau. Bạn nên sử dụng tính năng nào của trình duyệt web?",
    options: [
      "Duyệt đa trang cùng lúc (Multi-tab browsing)",
      "Mục yêu thích hoặc Đánh dấu trang (Favorites / Bookmarks)",
      "Lịch sử hoặc Dòng thời gian (History / Timeline)",
      "Hộp địa chỉ (Address box)"
    ],
    answer: "Mục yêu thích hoặc Đánh dấu trang (Favorites / Bookmarks)",
    explanation: "Tính năng Bookmarks (Đánh dấu trang) hoặc Favorites (Mục yêu thích) trên trình duyệt giúp người dùng lưu trữ cố định các URL của các trang web quan trọng để mở lại bất cứ lúc nào mà không cần tìm kiếm hay nhập lại địa chỉ."
  },
  {
    ...
    difficulty: "medium",
    type: "matching",
    question: "Với mỗi câu phát biểu về phần mềm mã nguồn mở (Open-source software), hãy chọn Đúng hoặc Sai:",
    left: [
      "Bất kỳ ai cũng có quyền kiểm tra, nghiên cứu, sửa đổi và cải tiến mã nguồn của phần mềm mã nguồn mở",
      "Tất cả các phần mềm được cung cấp miễn phí (Freeware) trên mạng đều là phần mềm mã nguồn mở",
      "Bạn bắt buộc phải đọc và đồng ý với thỏa thuận cấp phép người dùng cuối (EULA) trước khi sử dụng phần mềm mã nguồn mở"
    ],
    right: [
      "Đúng",
      "Sai"
    ...
    answer: {
      "Bất kỳ ai cũng có quyền kiểm tra, nghiên cứu, sửa đổi và cải tiến mã nguồn của phần mềm mã nguồn mở": "Đúng",
      "Tất cả các phần mềm được cung cấp miễn phí (Freeware) trên mạng đều là phần mềm mã nguồn mở": "Sai", // Rất nhiều freeware đóng mã nguồn, chỉ cho dùng miễn phí chứ không cho sửa mã.
      "Bạn bắt buộc phải đọc và đồng ý với thỏa thuận cấp phép người dùng cuối (EULA) trước khi sử dụng phần mềm mã nguồn mở": "Sai" // Phần mềm mã nguồn mở dùng giấy phép nguồn mở như GNU GPL, MIT, Apache... chứ không dùng EULA thương mại đóng.
    },
    explanation: "Bản chất của phần mềm mã nguồn mở là công khai mã nguồn cho cộng đồng tùy biến. Phần mềm miễn phí (Freeware) thường vẫn giữ kín mã nguồn (đóng). Thỏa thuận EULA thường áp dụng đối với phần mềm độc quyền thương mại."
  },
  {
    id: 95, // Tương ứng Test 1 - Câu 36
    level: "IC3_LEVEL1",
    test: 1,
    category: "DIGITAL_CITIZENSHIP",
    difficulty: "easy",
  ...
  },
  {
    ...
    right: [
      ...
      "Ổ đĩa cứng cơ học (HDD - Hard Disk Drive)"
    ],
    answer: {
  ...
  {
    id: 100, // Tương ứng Test 1 - Câu 42
    level: "IC3_LEVEL1",
    test: 1,
    category: "HARDWARE",
    difficulty: "medium",
  ...
  },
  {
    ...
    answer: {
      "Bạn chỉ phải thực hiện trích dẫn nguồn khi sao chép và sử dụng nguyên văn 100% câu chữ chính xác từ tác phẩm gốc của người khác": "Sai", // Kể cả khi diễn đạt lại (paraphrase) vẫn phải trích dẫn nguồn ý tưởng.
      ...
      "Trong tất cả mọi tác phẩm viết nghiên cứu, bạn bắt buộc phải sử dụng duy nhất phần chú thích ở chân trang (Footnote) để làm hình thức trích dẫn nguồn": "Sai", // Có nhiều kiểu trích dẫn như in-text citation (APA, MLA) ở ngay trong ngoặc đơn chứ không chỉ có footnote.
  ...
  {
    id: 103, // Tương ứng Test 1 - Câu 45
    level: "IC3_LEVEL1",
    test: 1,
    category: "HARDWARE",
    difficulty: "medium",
    ...
    answer: {
      ...
      "Cho phép học sinh kết nối với phòng máy tính của nhà trường từ mọi nơi": "Sai", // Thực tế không thể truy cập tự do từ mọi nơi nếu không có hạ tầng VPN chuyên dụng và bảo mật khắt khe.
  ...
  },
  {
    ...
    options: [
      ...
      "Thiết bị định tuyến (Router)",
      "Thiết bị điều chế và giải điều chế (Modem)",
      "Bộ điều hợp mạng (Network Adapter)"
    ],
    answer: "Thiết bị điều chế và giải điều chế (Modem)",
  ...
  {
    id: 105, // Tương ứng câu hỏi cuối của bộ tài liệu
    level: "IC3_LEVEL1",
    test: 2,
    category: "DIGITAL_CITIZENSHIP",
    difficulty: "medium",
    type: "single",
    question: "Khi bạn gửi một email cho đồng nghiệp, việc viết hoa toàn bộ tất cả các chữ cái trong nội dung thư (ví dụ: 'YÊU CẦU NỘP BÁO CÁO NGAY') được hiểu theo quy tắc ứng xử Netiquette trực tuyến là hành vi như thế nào?",
    options: [
      "Thể hiện sự chuyên nghiệp và nhấn mạnh tầm quan trọng tối cao của công việc",
      "Tương đương với hành vi la hét, quát tháo vào mặt người nhận và bị coi là rất bất lịch sự",
      "Giúp người nhận dễ đọc văn bản hơn trên các thiết bị di động nhỏ",
      "Là một cách viết chuẩn mực bắt buộc trong các thư từ thương mại điện tử"
    ],
