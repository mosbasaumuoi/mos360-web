...
async function sendPaymentConfirmEmail(env, { toEmail, toName, khoaHoc, soTien, maDangKy }) {
    ...
    const html = `
      <div style="font-family:Arial,sans-serif;max-width:560px;margin:0 auto;color:#1a1a2e">
        ...
        <p>2. Hướng dẫn cài đặt phần mềm MOS360 từng bước: <a href="https://go.mos360.vn/hdcaimos360">Xem hướng dẫn</a></p>
        <p>3. Hướng dẫn tải và cài đặt Office: <a href="https://go.mos360.vn/hdcaioffice2019">Xem hướng dẫn</a></p>
